...
![Ya Selva + Break This Loop — two wings of the same organism](../images/ya-selva-break-this-loop-two-wings.png)
...
[`01-the-connection.md`](01-the-connection.md) (vault: `break-this-loop/000-ya-selva-btl-connection`) is the canonical master note on how the two projects relate (presence-dependent vs. presence-independent, the collect/sing/open loop, Graceland as template, the stems question).
...
- [`01-the-connection.md`](01-the-connection.md) — the master connection note (presence-dependent vs. presence-independent)
