---
title: The Global History and Musical Function of the Pentatonic Field 1–2–4–5–♭7
...
```mermaid
flowchart LR
    S["Pitch inventory: D E F# A B"]
    S --> D["D centered<br/>1 2 3 5 6<br/>major pentatonic"]
    S --> B["B centered<br/>1 b3 4 5 b7<br/>minor pentatonic"]
    S --> E["E centered<br/>1 2 4 5 b7<br/>target field"]
    E --> Q["Question of this study:<br/>is E actually HOME?"]
```
...
```mermaid
flowchart LR
    AE["Ancient Egypt<br/>instruments & drone-capable practices<br/>exact target NOT established"]
    CN["Early Chinese pitch theory<br/>five-tone categories develop historically<br/>exact performance continuity must be cautious"]
    OR["Oral traditions<br/>antiquity often unknown"]
    ET["19th–early 20th c.<br/>folk-song & ethnographic transcription"]
    RE["Early recordings<br/>Native American / blues / folk"]
    JZ["1965<br/>Maiden Voyage: modern thirdless constant structure"]
    ML["1970s onward<br/>Ali Farka Touré radio & international recordings"]
    WS["1990s documentation<br/>Wassoulou kamalengoni / Oumou Sangaré"]
    NOW["Contemporary hybrid practices"]
